...
export default function Welcome() {
    ...
    return (
        <AppLayout>
            <div className="flex flex-col gap-16 md:gap-24 animate-fade-in relative z-0 pb-12">
                ...
                <section className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto px-4 w-full">
                    <div className="flex flex-col text-center p-8 rounded-3xl bg-surface-50/80 dark:bg-surface-800/40 border-2 border-surface-100 dark:border-surface-800 backdrop-blur-sm transition-all hover:-translate-y-1.5 hover:shadow-xl shadow-surface-200/50 dark:shadow-none group">
                    ...
                    <div className="flex flex-col text-center p-8 rounded-3xl bg-surface-50/80 dark:bg-surface-800/40 border-2 border-surface-100 dark:border-surface-800 backdrop-blur-sm transition-all hover:-translate-y-1.5 hover:shadow-xl shadow-surface-200/50 dark:shadow-none group relative">
                ...
                {/* Quote / Testimonial */}
                <section className="relative max-w-4xl mx-auto w-full px-4 text-center py-12 md:py-20">
                ...
                <section className="max-w-5xl mx-auto w-full space-y-10 px-4 pt-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <a
                            ...
                            className="group flex flex-col gap-6 rounded-[2rem] border-2 border-surface-100 dark:border-surface-800/80 bg-white/60 dark:bg-surface-800/30 backdrop-blur-md p-8 text-left transition-all duration-300 hover:bg-white dark:hover:bg-surface-800 hover:-translate-y-2 hover:shadow-2xl hover:shadow-surface-200/20 hover:border-surface-300 dark:hover:border-surface-600"
                        >
                            ...
                            <div className="space-y-3">
                                ...
                                {isStaff && (
                                    <p className="text-xs font-semibold uppercase tracking-wider text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/60 rounded-lg px-3 py-2 w-fit">
                                        Beta release: Facebook Messenger integration is in dev mode currently.
                                    </p>
                                )}
                                <p className="text-lg text-surface-600 dark:text-surface-400 leading-relaxed font-medium">
                ...
                {/* Footer block */}
                <div className="max-w-5xl mx-auto w-full pt-16 mt-8 flex flex-col items-center justify-center gap-8 border-t border-surface-200 dark:border-surface-800 px-4">
